  ...
  return (
    <div className="custom-form-antd">
      <div className="row mb-5">
        ...
        <div className="radio-button" onChange={(e) => console.log("abc")}>
          <div className="radio1">
            <input type="radio" value="new" checked /> tạo mới
          </div>
          <div className="radio2">
            <input type="radio" value="old" /> thay đổi từ quy
            trình cũ
          </div>
        </div>
        <br/>
        <div className="table">
          ...
          <div className="step">
            <div className="start">
            Bắt đầu<br/>dd/mm/yyyy
            </div>
            <div className="icon">icon</div>
            <div className="xoidat"></div>
          </div>
        </div>
      </div>
    </div>
